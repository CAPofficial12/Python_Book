...
#yes, it's not quite accurate, but that's the comment it had whne this version was published. wasn't accurate then, either, but a new comment didn't warrant a beta 5.1 so we just went to 1.0.0-rc.1