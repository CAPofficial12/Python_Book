...
def load_pass():
    ...
    #except FileNotFoundError:
        #passwords = []
        #print("YOU HAVE HAD A CATA-HATA-HATA-HATA-STROPHIC ERROR PLS PUT THE PASSWORDS FILE *BACK*, THANK YOU")
    ...
    while owner_run:
        ...
        if owner_choice == "1":
            ...
            if new_password == also_new:
                sublog.append(f"{timestamp()} OWNER CHANGES PASSWORD TO {new_password} FROM {passwords[2]}")
...
while run:
    if access == 1:
        ...
        open_menu()
#1762 lines is 1761 too many. all i need is print("Hello world!") and i'm satisfied.  