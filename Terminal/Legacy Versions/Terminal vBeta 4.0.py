...
def user_direct_messages():
    ...
    while umrun:
        ...
        if message_choice == "1":
            ...
            if len(user_dm) > 5:
                user_dm.pop(0)
                for i in enumerate(user_dm, start=1):
                    print(f"{i}")
...
def admin_direct_messages():
    ...
    while amrun:
        ...
        if message_choice == "1":
            ...
            if len(admin_dm) > 5:
                admin_dm.pop(0)
                for i in enumerate(admin_dm, start=1):
                    print(f"{i}")
                go_back() 
            elif len(admin_dm) == 0:
                print("INBOX EMPTY")
...
def maint_direct_messages():
    ...
    while mmrun:
        ...
        if message_choice == "1":
            ...
            if len(maint_dm) > 5:
                maint_dm.pop(0)
                for i in enumerate(maint_dm, start=1):
                    print(f"{i}")
                go_back()
            elif len(maint_dm) == 0:
                print("INBOX EMPTY")
    ...
    while omrun:
        ...
        if message_choice == "1":
            ...
            if len(owner_dm) > 5: #you can have max 5 messages, like old mobile phones! cool huh?
                owner_dm.pop(0)
                for i in enumerate(owner_dm, start=1):
                    print(f"{i}")
                go_back()
            elif len(owner_dm) == 0:
                print("INBOX EMPTY")
...
#yuck
def header():
    print("BENTRAYS TERMINAL SYSTEM, VERSION BETA 4.0")
    print("_" * 41)
        ...
        if command_choice == "1":
            ...
            if command == "log.wipe":
                ...
                if len(sublog) == 0:
                    ...
                    for i in enumerate(sublog, start=1):
                        print(f"{i}")
    ...
    while admin_run:
        ...
        if admin_choice == "1":
            ...
            if result == "y":
                ...
                sublog.append(timestamp() + " " + "ADMIN ENTERS INVALID OPTION")
                sublog.append(f"{timestamp()} ADMIN LOGS OUT")
                admin_run = False
...
def view_logs():
    ...
    if len(logs) == 0:
        ...
        print("\n----LOG FILE----")
        for i in enumerate(logs, start=1):
            print(f"{i}")
        go_back()
...
while run:
    if access == 1:
        ...
        open_menu()
#1516 lines is 1515 too many. all i need is print("Hello world!") and i'm satisfied.  